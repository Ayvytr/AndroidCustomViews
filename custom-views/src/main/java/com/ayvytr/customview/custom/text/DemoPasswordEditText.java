 ...
 */
public class DemoPasswordEditText extends AppCompatEditText {
	...
	@DrawableRes
	private int showPwIcon = R.drawable.ic_show_password;

	@DrawableRes
	private int hidePwIcon = R.drawable.ic_hide_password;
	...
	public DemoPasswordEditText(Context context) {
		this(context, null);
	}

	public DemoPasswordEditText(Context context, AttributeSet attrs) {
		super(context, attrs);
		initFields(attrs, 0);
	}

	public DemoPasswordEditText(Context context, AttributeSet attrs, int defStyleAttr) {
	...
	public void initFields(AttributeSet attrs, int defStyleAttr) {
		...
		if (attrs != null) {
			TypedArray styledAttributes = getContext().getTheme().obtainStyledAttributes(attrs, R.styleable.DemoPasswordEditText, defStyleAttr, 0);
			try {
				showPwIcon = styledAttributes.getResourceId(R.styleable.DemoPasswordEditText_pet_iconShow, showPwIcon);
				hidePwIcon = styledAttributes.getResourceId(R.styleable.DemoPasswordEditText_pet_iconHide, hidePwIcon);
				hoverShowsPw = styledAttributes.getBoolean(R.styleable.DemoPasswordEditText_pet_hoverShowsPw, false);
				useNonMonospaceFont = styledAttributes.getBoolean(R.styleable.DemoPasswordEditText_pet_nonMonospaceFont, false);
				disableIconAlpha = styledAttributes.getBoolean(R.styleable.DemoPasswordEditText_pet_disableIconAlpha, false);
			} finally {
